	...
	public static class HighlightingDefinitionParser
	{
		...
		public static DefaultHighlightingStrategy Parse(DefaultHighlightingStrategy highlighter, SyntaxMode syntaxMode, XmlReader xmlReader)
		{
			...
			try {
                ...
                Stream shemaStream = typeof(HighlightingDefinitionParser).Assembly.GetManifestResourceStream("FluentSharp.SharpDevelopEditor._O2SharpDevelop.ICSharpCode.TextEditor.Project.Resources.Mode.xsd");
