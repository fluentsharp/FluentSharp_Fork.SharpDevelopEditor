...
namespace ICSharpCode.NRefactory.Visitors
{
	...
	public class CSharpConstructsConvertVisitor : ConvertVisitorBase
	{
        ...
        void ConvertForStatement(ForStatement forStatement)
        {
            ...
            forNextStatement.VariableName = iteratorIdentifier.Identifier;
            forNextStatement.Start = start;
            forNextStatement.End = end;
            forNextStatement.Step = (step == 1) ? null : new PrimitiveExpression(step, step.ToString(System.Globalization.NumberFormatInfo.InvariantInfo));
            forNextStatement.EmbeddedStatement = forStatement.EmbeddedStatement;

            ReplaceCurrentNode(forNextStatement);
        }
